...
function startSecondAnimation() {
  // Create the "Next Surprise" button
  ...
  // On click → hide canvas & show cake animation
  nextBtn.addEventListener("click", () => {
    document.getElementById("c").style.display = "none"; // Hide fireworks
    document.getElementById("second-animation").style.display = "block"; // Show cake
    nextBtn.remove();
  });
}
